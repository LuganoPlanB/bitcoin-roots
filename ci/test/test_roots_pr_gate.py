...
class RootsPrGateTest(unittest.TestCase):
    ...
    def test_workflow_is_pinned_read_only_and_offline(self):
        ...
        for required in ("pull_request:", "contents: read", "path: trusted-base", "path: candidate", "bundle create", "--record candidate/contrib/roots/continuous-accounting-pr.json"): self.assertIn(required, workflow)
